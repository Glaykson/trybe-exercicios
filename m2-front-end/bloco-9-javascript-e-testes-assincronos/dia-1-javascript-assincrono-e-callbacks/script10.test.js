...
describe('Scoped / Nested block', () => {
  beforeEach(() => console.log('2 - beforeEach')); // antes de cada teste no escopo do describe.
  afterEach(() => console.log('2 - afterEach')); // depois de cada teste no escopo do describe.

  test('', () => console.log('2 - test')); // o teste no escopo do describe.
});
